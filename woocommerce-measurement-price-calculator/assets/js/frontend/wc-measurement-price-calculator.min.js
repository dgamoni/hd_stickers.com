...
jQuery(document).ready(function(a) {
    ...
    function run_plugin() {
		    ...
		    a(document).bind("reset_image", function() {
		        ...
		        var h = "";
		        if (c ? (h = wc_price_calculator_params.product_price * c, wc_price_calculator_params.minimum_price > h && (h = parseFloat(wc_price_calculator_params.minimum_price)), a(".price").html(g(h)).trigger("wc-measurement-price-calculator-product-price-change", [c, h])) : a(".price").html("").trigger("wc-measurement-price-calculator-product-price-change"), a(".wc-measurement-price-calculator-total-amount")) {
...
a("input[name=attribute_pa_sticker_size]").on("click", function() {

	//console.log(a('input[name=attribute_pa_sticker_size]:checked').val());

	if( a('input[name=attribute_pa_sticker_size]:checked').val() == 'custom-size') {
		console.log('checked');

		a('#price_calculator').css('opacity', '1');
		run_plugin();
    	// a('.woocommerce-variation-price-custom').css('opacity', '1');
    	// a('.woocommerce-variation-price').css('opacity', '0');

	}//end if
	else {
		console.log('other check');
		 //a('#price_calculator').detach();
		a('#price_calculator').css('opacity', '0');
		a('#length_needed').val('1');
    	a('#width_needed').val('1');
    	// a('.woocommerce-variation-price-custom').css('opacity', '0');
    	// a('.woocommerce-variation-price').css('opacity', '1');
